...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[_BASE] = LAYOUT_ortho_2x2u(
		...
		KC_LCTL,  KC_LGUI, KC_LALT, TT(_FN), MO(_LWR),           KC_SPACE,            KC_ENT,          MO(_RSE),  KC_RGUI,  KC_HOME,  KC_END,    KC_RCTL
	),
	...
	[_LWR] = LAYOUT_ortho_2x2u(
        ...
        KC_LCTL,  _______,    _______,     _______,      _______,          _______,         KC_DEL,  _______,  RESET,   _______, _______, _______
    ),
    ...
    [_FN] = LAYOUT_ortho_2x2u(
        ...
        KC_LOCK, _______, _______, _______,          _______, _______, _______,  _______, RESET,   _______, _______, _______
    )
