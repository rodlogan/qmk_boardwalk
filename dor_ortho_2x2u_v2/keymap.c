...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[_LWR] = LAYOUT_ortho_2x2u(
        KC_MEDIA_PLAY_PAUSE,    KC_F1,        KC_F2,        KC_F3,         KC_F4,        KC_F5,         KC_F6,       KC_F7,       KC_F8,       KC_F9,       KC_F10,     KC_F11,      KC_F12,     KC_DEL,
        ...
        KC_LSFT,    			LCTL(KC_A),   LCTL(KC_X),   LCTL(KC_C),    RCS(KC_V),    COPYTAB,       KC_CALC,     KC_MUTE,     KC_VOLD,     KC_VOLU,     _______,    _______,     _______,    KC_RSFT,
	...
	[_RSE] = LAYOUT_ortho_2x2u(
        ...
        _______,   _______,   WEMAIL,    EMAIL,     BR,        LCTL(KC_LSFT),   RCTL(KC_RSFT),   _______,     _______,    _______,   		 KC_INS,          _______,       PWD,       KC_BSLS,
        _______,   _______,   _______,   _______,   _______,   _______,   		_______,   		 _______,     KC_ASTR,    KC_MINS,   		 KC_EQL,          KC_HASH,       KC_AMPR,   KC_BSLS,
        _______,   _______,   _______,   KC_CALC,   _______,   _______,   		_______,    	 KC_MUTE,     KC_UNDS,    KC_PLUS,           LCTL(KC_LSFT),   RCTL(KC_RSFT), _______,   KC_RSFT,
        RESET,     _______,   _______,   _______,   _______,           KC_BSPC,            _______,           _______,    LCA(KC_DEL),       _______,         _______,       KC_RCTL
    ),
	...
	[_FN] = LAYOUT_ortho_2x2u(
        ...
        KC_WH_D,    KC_HOME,    	LCTL(KC_END),     KC_END,     	  KC_WSCH,      GUI_TOG,    KC_MINS,      KC_4,      KC_5,           KC_6,       KC_MINS,    _______,    _______,   _______, 
        A(KC_RSFT), LCTL(KC_Z),     LCTL(KC_Y),   	  LCTL(KC_C),     LCTL(KC_V),    _______,    KC_PPLS,     KC_1,      KC_2,           KC_3,       KC_PPLS,    _______,    _______,   _______,
