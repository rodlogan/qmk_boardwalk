...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[_LWR] = LAYOUT_ortho_2x2u(
        KC_MEDIA_PLAY_PAUSE,    KC_F1,        KC_F2,        KC_F3,         KC_F4,        KC_F5,         KC_F6,       KC_F7,       KC_F8,       KC_F9,       KC_F10,     KC_F11,      KC_F12,     KC_BSPC,
        ...
        KC_LSFT,    			LCTL(KC_A),   LCTL(KC_X),   LCTL(KC_C),    LCTL(KC_V),    COPYTAB,       KC_CALC,     KC_MUTE,     KC_VOLD,    KC_VOLU,     BS,   		PAREN,   	 DQT,        KC_RSFT,
	...
	[_RSE] = LAYOUT_ortho_2x2u(
        ...
        _______,   _______,   _______,   KC_CALC,   _______,   _______,   		_______,    	 KC_MUTE,              KC_ASTR,    KC_UNDS,          KC_DQT,   		  KC_PIPE, 	      KC_BSLS,   		KC_RSFT,
        RESET,     _______,   _______,   _______,   TG(_GM),           KC_BSPC,                             _______,           _______,    LCA(KC_DEL),               LCTL(KC_LSFT),  RCTL(KC_RSFT),    KC_RCTL
    ),
	...
	[_FN] = LAYOUT_ortho_2x2u(
        ...
        A(KC_RSFT), LCTL(KC_Z),     LCTL(KC_Y),   	  LCTL(KC_C),     RCS(KC_V),    _______,    KC_PPLS,     KC_1,      KC_2,           KC_3,       KC_PPLS,    _______,    _______,   _______,
	...
	[_GM] = LAYOUT_ortho_2x2u(
		...
		KC_LCTL,    KC_F13,    TT(_FN),   KC_LALT,    KC_RCTL,          KC_SPACE,                  KC_SFTENT,          TG(_GM),   KC_RGUI,    KC_HOME,    KC_END,      KC_RCTL
    )
